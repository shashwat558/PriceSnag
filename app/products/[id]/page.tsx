...
const ProductDetails = async({params: { id }} : Props) => {
  ...
  return (
    <div  className='product-container'>
            ...
            <div className='flex-1 flex flex-col'>
                <div className='flex justify-between items-start gap-5 flex-wrap pb-6'>
                    ...
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='flex gap-3 p-2 bg-white-200 rounded-10'>
                            <Image 
                ...
                <div className='product-info'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <p className='text-[20px] text-black opacity-50 line-through'>{product.currency} {formatNumber(product.originalPrice)}</p>
                        ...
                        <div className='flex gap-3'>
                            <div className='product-stars'>
                                <Image
                                  ...
                                  height={16} 
                                />
                                <p className='text-sm text-primary-orange font-semibold'>{product.stars || 24}</p>
                            </div>
        ...
        <div className='flex flex-col gaborder-2 border-red-500p-16 '>
